...
<div className="md:container md:mx-auto   ">
                ...
                <div className=" w-full h-auto  lg:max-w-full lg:flex">
                    ...
                    <div className="mx-auto w-full border-r border-b border-l border-t mt-1  border-gray-500 lg:border-l-1 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r lg:rounded-l  flex">
