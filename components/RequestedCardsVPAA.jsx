...
export default function RequestedCardsVPaa({ booksVPAADisplay }) {
  return (
   ...
   lg:border-gray-400 bg-white  lg:rounded-b-1
    lg:rounded-r p-4 flex flex-col justify-between leading-normal"
        >
          ...
          <h4 className="text-gray-600 font-bold text-2xl mb-2">{booksVPAADisplay.title}</h4>
          <p className="text-gray-600 mb-5">
            {booksVPAADisplay.notereqform}
          </p>
          ...
          <div>
            ...
            <p className=" font-thin ">
              { booksVPAADisplay.userID}
            </p>
          </div>
          <div>
            <small className="font-bold mr-2">Name</small>
            <p className=" font-thin ">
              { booksVPAADisplay.requestee}
            </p>
          </div>
          <div>
            <small className="font-bold mr-2">Position</small>
            <p className=" font-thin ">
              { booksVPAADisplay.selectPosition}
            </p>
          </div>
          <div>
            <small className="font-bold mr-2">Requestee Department</small>
            <p className=" font-thin ">
              { booksVPAADisplay.selectDepartment}
            </p>
          </div>
          <div>
            <small className="font-bold">Publication Date</small>
            <p className=" font-thin">
              {new Date(booksVPAADisplay.pubdate).toDateString()}
            </p>
          </div>
          <div>
            <small className="font-bold">Requested Date</small>
            <p className=" font-thin">
              {new Date(booksVPAADisplay.date).toDateString()}
            </p>
            <Link href={`/approve-books-VPAA/${booksVPAADisplay.requestID}`}>
              <button
                type="button"
