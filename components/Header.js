      ...
      <div className="max-w-10xl MT mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div className=" flex items-center justify-between h-16">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button className="mr-2 bg-gray-700 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none ring-1 focus:ring-offset-1 focus:ring-offset-gray-700 focus:ring-white">
            ...
            <button className="bg-gray-700 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none ring-1 focus:ring-offset-0 focus:ring-offset-gray-700 focus:text-red-50 focus:ring-white">

              <Link href="../registration"><span className=" mr hover:text-gray-900 text-gray-300 px-3 py-2 rounded-md text-sm font-medium">Sign Up</span></Link>
            </button>
