...
export default async function (req, res) {
    try {
        const { date, rushornrush, authorName, title, edition, copvol, pubdate, pubName, pubAddress, recomby, position, chargeto, subject, enumtitle, notereqform, dealer, price,dated, sinumb, addedAs} = req.body;
