...
export const getServerSideProps = async (context) => {
    const { booksPub } = context.query;
    const { data } = await api.get(`/api/bookstopublish/${booksPub}`);

    console.log(data);

    return {
        props: { booksToEnter: data },
                ...
                <>
                    <Form
                        ...
                        render={({ handleSubmit }) => (
                            ...
                            <form onSubmit={handleSubmit} className=" p-8 bg-blue-200 rounded-md my-16 shadow-md mx-auto w-full min-h-screen  ">

                                <div className="flex-shrink-0 flex content-around items-center">

                                    <img className="hidden lg:block h-14 w-auto  mr-3" src="/cpulogo.png" alt="okay" />
                                    <img className="block lg:hidden h-14 w-auto  mr-3" src="/cpulogo.png" alt="cpu logo" />
                                    <h1 className="text-3xl font-bold text-black-600 ">Library Acquisition Entry of Books</h1>
                                ...
                                <div className="flex space-x-6 content-around items-center  justify-end p-8">
                                    ...
                                    <label htmlFor="date" className="block ">
                                        <span className="block  text-sm font-bold text-black-500 mb-1">Book Updated</span>
                                        <Field
                  ...
                  focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                ...
                                                name="userID"
                                                type="text"
                                                initialValue={booksToEnter.userID}
                                                disabled
                                        ...
                                        <label htmlFor="author" className="">
                                            <span className="block hover:textColor-red  text-sm x font-bold text-black-500 mb-1">Name</span>
                                            <Field
                                                className="text-black-500 rounded-md  w-full
                    focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                component="input"
                                                name="requestee"
                                                type="text"
                                                initialValue={booksToEnter.requestee}
                                                disabled
                                            />
                                        </label>
                                    </div>
                  ...
                  focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                ...
                                                type="text"
                                                placeholder="Author"
                                                initialValue={booksToEnter.authorName}
                                                disabled
                                            />
                                        </label>
                  ...
                  focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                ...
                                                type="text"
                                                placeholder="Title"
                                                initialValue={booksToEnter.title}
                                                disabled
                                            />
                                        </label>
                                    </div>
                    ...
                    focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                ...
                                                name="NumberOfCopies"
                                                type="text"
                                                initialValue={booksToEnter.copvol}
                                                disabled
                                            />
                                        </label>
                    ...
                    focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                ...
                                                name="Edition"
                                                type="text"
                                                initialValue={booksToEnter.edition}
                                                disabled
                                            />
                                        </label>
                                            <small className="  text-sm font-bold text-black-600  mt-4">Approved By:</small>

                                            <span className="font-thin block ">
                                                President:
                                                {' '}
                                                {booksToEnter.approvalPresident ? '✓' : 'No'}
                                            </span>
                                            <span className="font-thin block ">
                                                Finance:
                                                {' '}
                                                {booksToEnter.approvalFinance ? '✓' : 'No'}
                                            </span>
                                            <span className="font-thin block ">
                                                Director:
                                                {' '}
                                                {booksToEnter.approvalDirector ? '✓' : 'No'}
                                            </span>
                                            <span className="font-thin block ">
                                                Acquisition:
                                                {' '}
                                                {booksToEnter.approvalAcqui ? '✓' : 'No'}
                                            </span>
                                    ...
                                    <div className="row-start-3 gap-y-2">
                                        ...
                                        <label htmlFor="selectDosition" className="block">
                                            <span className="block  text-sm font-bold text-black-500 p">Status</span>
                                            <Field
                                                name="status"
                                                component="select"
                                                className=" text-black-500 rounded-md  w-4/6
                    focus:placeholder-black-700 focus:border-black-500 placeholder-black-700  placeholder-opacity-50 bg-black-50"
                                                required
                                            >

                                                <option value=""> Select Status </option>
                                                <option className=" text-sm font-bold text-black-500" value="3">Publish</option>
                    ...
                    focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                ...
                                                type="text"
                                                initialValue={new Date(booksToEnter.pubdate).toDateString()}
                                                disabled
                                            />
                                        </label>
                  ...
                  focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                                ...
                                                name="noteDeanbook"
                                                type="input"
                                                initialValue={booksToEnter.notereqform}
                                                disabled
                                            />
                                        </label>
                                    ...
                                    <Field
                                        className="text-black-500 rounded-md  w-full h-full
                  focus:placeholder-black-700 focus:border-black-500 placeholder-black-700 border-0 placeholder-opacity-50 bg-black-50"
                                        component="input"
                                        name="requestID"
                                        type="hidden"
                                        initialValue={booksToEnter.requestID}
                                    />
                                </div>
