                ...
                render={({ handleSubmit }) => (
                    ...
                    <form onSubmit={handleSubmit} className=" px-8 pt-8 pb-8 bg-white rounded-md my-16 w-2/3 mx-auto min-h-screen ">
                        ...
                        <label htmlFor="title" className=" ">
                            ...
                            <Field className="focus:placeholder-gray-500 text-xs placeholder-gray-500 placeholder-opacity-50   pt-3 pb-2 block px-0 mt-0 bg-transparent 
                        ...
                        <label htmlFor="recom" className=" mt-4 border-t-">
                            ...
                            <Field className="text-xs focus:placeholder-gray-400  placeholder-gray-500 placeholder-opacity-50  placeholder- pt-3 pb-2
                        ...
                        <div className=" flex  content-center ">
                            ...
                            <label htmlFor="staff" className="mr-2 mt-2 block">
                                <Field className=" text-gray-500 form-radio h-3 w-3 rounded-sm" name="recomby" component="input" type="radio" value="Others" />
                        ...
                        <div className="mt-7">
                            <label htmlFor="chargedto" className=" h-48">
                                ...
                                <Field className="text-xs mr-4 w-5/12 span-12 form-text focus:placeholder-gray-500 placeholder-gray-500 placeholder-opacity-50  pt-3 pb-2 
                            block px-0 mb-2 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-400"
                        ...
                        <div className="flex  justify-end">
                            <label htmlFor="subjectr" className="">
                                ...
                                <Field className=" mr-8 text-xs  justify-endform-text focus:placeholder-gray-500 placeholder-gray-500 placeholder-opacity-50  pt-3 pb-2 
                            block px-0 mb-2 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-400"
                                    component="input" name="subject" type="text" placeholder="Subject " />
                            </label>
                            <label htmlFor="enumtitle" className="">
                                ...
                                <Field className=" text-xs  focus:placeholder-gray-500 placeholder-gray-500 placeholder-opacity-50  pt-3 pb-2 
                            block px-0 mb-2 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-400"
                        ...
                        <div className="flex flex-row space-x-5 content-around items-center">
                            <label htmlFor="notereqform" className="">
                                ...
                                <Field className="resize-x border text-xs  rounded-md focus:placeholder-gray-500
                                 placeholder-gray-500 placeholder-opacity-50  " component="textarea" name="notereqform" type="input" placeholder="Note here" />
                            </label>
                        </div>
                        ...
                        <div className="flex flex-row space-x-3 content-around justify-center">
                            ...
                            <label htmlFor="dealer" className="mt-4">
                                ...
                                <Field className="  text-xs w-1/10 form-text focus:placeholder-gray-500 placeholder-gray-500 placeholder-opacity-50  pt-3 pb-2 
                            ...
                            <label htmlFor="dated" className="mt-4">
                                ...
                                <Field className="  text-xs form-text focus:placeholder-gray-500 placeholder-gray-500 placeholder-opacity-50  pt-3 pb-2 
                            ...
                            <label htmlFor="SI#:" className="mt-4">
                                ...
                                <Field className="  text-xs w-1/4 form-text focus:placeholder-gray-500 placeholder-gray-500 placeholder-opacity-50  pt-3 pb-2 
                             px-0 mb-2 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-400"
                        ...
                        <div className="mt-4 flex flex-row space-x-4 content-around items-center justify-end">
                            ...
                            <label htmlFor="nrush" className="ml-1">
                                ...
                                form-radio h-3 w-3 rounded-sm " name="addedAs" component="input" type="radio" value="New Copy" />
                                <span className="  text-xs font-bold  text-gray-500 mb-1">New Copy</span>
                            </label>

                            <label htmlFor="nrush" className=" ml-1">
                                <Field className=" text-xs text-gray-500 
                                form-radio h-3 w-3 rounded-sm " name="addedAs" component="input" type="radio" value="New Edition" />
                                <span className="  text-xs font-bold  text-gray-500 mb-1 mr-1 ">New Edition</span>
                            </label>
                            
                            <label htmlFor="nrush" className="mr-1">
                                <Field className="ml-6 text-xs text-gray-500 
                                form-radio h-3 w-3 rounded-sm " name="addedAs" component="input" type="radio" value="Replacement" />
